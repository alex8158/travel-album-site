> **状态：历史归档（v1 MVP，2026-03-31）**
>
> 本文档是 v1 MVP 的技术设计，对应根目录 `requirements.md` 第一部分的 7 条基线需求，已于 2026-03-31 完成。
>
> **它不是当前架构的准确描述。** 自 2026-04-09 起，架构通过 `.kiro/specs/<feature>/design.md` 逐次迭代演进（流水线三段式重构、智能筛选三阶段、异步任务化等），本文档未同步更新。
>
> 需要当前设计依据时，请查 `.kiro/specs/` 下对应功能的 design.md；文档权威顺序见 `AGENTS.md` 第 5.1 节。本文档按约定保持原样，不随代码更新。
